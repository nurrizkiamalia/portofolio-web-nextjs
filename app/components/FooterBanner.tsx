        ...
        <>
            <div className="footer-container flex justify-between items-center bg-offblack p-20">
                <div className="footer-text flex flex-col text-white ">
                    ...
                    <h2 className="text-heading2 with-pic flex items-center gap-3"><img src="assets/hero-img.png" className="footer-img w-20 h-20 rounded-full object-cover object-top bg-lightgray outline-none  border-none"/>let's build it together.</h2>
                </div>
